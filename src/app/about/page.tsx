  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-16">
      ...
      <div className="space-y-6 text-ink-light leading-relaxed">
        ...
        <EditableText
          contentKey="about-p2"
          defaultValue="Each item in the archive has been carefully digitized and annotated with its year of publication, volume and issue number, and a brief contextual description. The collection is organized chronologically, allowing researchers and casual visitors alike to trace visual narratives across decades."
          multiline
        />

        <EditableText
          contentKey="about-p3"
          defaultValue="This project was born from a recognition that visual records — often treated as secondary to textual sources — carry their own irreplaceable historical weight. A photograph of a campus quad, a portrait of a faculty member, or a snapshot from a student gathering can convey what written accounts cannot: the texture of a particular moment in time."
          multiline
        />

        <EditableText
          contentKey="about-p4"
          defaultValue="The archive is an ongoing effort. New material is added as it is discovered, verified, and digitized. If you have material that may be relevant to this collection, or if you would like to learn more about our preservation methods, we welcome your inquiry."
          multiline
        />

        <div className="text-sm text-ink-muted pt-4 border-t border-border">
          <span>For questions or contributions, please contact us at </span>
          <EditableText
            contentKey="about-email"
